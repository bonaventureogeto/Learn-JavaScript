...
for(let i = 0; i < something.length; i++) {
  something[i].innerHTML = "You can also access elements by their class name using the document.getElementsByClassName() method. This method returns an array-like collection of elements with the given class name";
}
